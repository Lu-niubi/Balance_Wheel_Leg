...
// 硬件引脚配置区 (根据实际接线修改此处)
// -------------------------------------------------------------------------
#define SERVO_CH1_PIN       (TCPWM_CH13_P00_3)//左下舵机
#define SERVO_CH4_PIN       (TCPWM_CH04_P04_0)//左上舵机  

//电机驱动黑色线部分
#define SERVO_CH2_PIN       (TCPWM_CH12_P01_0)//右上舵机  
#define SERVO_CH3_PIN       (TCPWM_CH11_P01_1)//右下舵机  
// -------------------------------------------------------------------------
// 舵机参数配置
// -------------------------------------------------------------------------
